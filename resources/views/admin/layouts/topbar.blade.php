        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box" style="margin-top:25px;">
                <a href="{{ url('index') }}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ asset('/assets/frontend/img/favicon.png') }}" alt="" height="60">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('/assets/frontend/img/favicon.png') }}" alt="" height="60">
                    </span>
            ...
            <div class="dropdown d-inline-block language-switch">
                <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown"
                    ...
                    @switch(Session::get('lang'))
                        @case('ru')
                            <img src="{{ asset('/assets/admin/images/flags/russia.jpg') }}" alt="Header Language"
                                height="16"> <span class="align-middle"></span>
                        @break

                        @case('it')
                            <img src="{{ asset('/assets/admin/images/flags/italy.jpg') }}" alt="Header Language" height="16">
                            <span class="align-middle"></span>
                        @break

                        @case('de')
                            <img src="{{ asset('/assets/admin/images/flags/germany.jpg') }}" alt="Header Language"
                                height="16"> <span class="align-middle"></span>
                        @break

                        @case('es')
                            <img src="{{ asset('/assets/admin/images/flags/spain.jpg') }}" alt="Header Language" height="16">
                            <span class="align-middle"></span>
                        @break
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item"
                        onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i
                            ...
                            class="align-middle">Sign_out</span></a>
